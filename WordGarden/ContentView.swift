...
//  WordGarden
//
//  Created by BARRERA, LARRY on 1/12/26.
//
            ...
            if playAgainHidden {
                HStack{
                    TextField("", text: $guessedLetter)
                        ...
                        .onSubmit {
                            // As long as guessedLetter is not an emptty String we can continue, otherwise dont do anything
